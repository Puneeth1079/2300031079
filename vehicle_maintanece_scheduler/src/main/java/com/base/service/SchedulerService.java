    ...
    public Object createSchedule() {
        ...
        for (Map<String, Object> depot : depots) {
            ...
            Map<String, Object> schedule =
                    solveKnapsack(depotId, budget, vehicles);
